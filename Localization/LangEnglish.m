...
+(NSString*) LOC_INFO_SCREEN_TEXT_ABOUT_INTRIGUE{return @"With this feature you can anonymously invite somebody to a conversation. All you need is the email of the person you are interested in. Enter the email in the corresponding field and hit the \"Intrigue email!\" button. After that, an email will be send to the entered address telling the person that somebody is interested in them, and anonymously invites them to communicate in Sapid Chat. You can optionally add an additional message to the invitation.\r\r\
