...
+(NSString*) LOC_MESSAGES_REPORT_PICKED_UP{return [[self AppLanguage] LOC_MESSAGES_REPORT_PICKED_UP];}
// compose screen
...
+(NSString*) LOC_SETTINGS_SECTION_MORE_TOUR {return [[self AppLanguage] LOC_SETTINGS_SECTION_MORE_TOUR];}
